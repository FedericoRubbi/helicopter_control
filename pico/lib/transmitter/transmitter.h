...
#define TX_TX_PIN 8
#define TX_RX_PIN 9
#define TX_PREAMBLE_SIZE (sizeof(tx_preamble))
#define TX_CONNECTED_FLAG 0xCC // expected receiver response after preamble
#define TX_EOP_FLAG 0xFF    // sent after every packet for synchronization
...
const uint8_t tx_preamble[] = {0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF};
#endif
