...
#define US_CHANGE_ADDR0 0xAA // send sequentially US_CHANGE_ADDR0 and US_CHANGE_ADDR1 to change address
#define US_CHANGE_ADDR1 0xA5
#define US_MAX_GRADIENT 5 // max range derivative in absolute value to apply kalman filter
#define US_MAX_SAMPLE_TIME 0.067 // max time required for a range measurement in seconds
